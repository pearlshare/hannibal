...
Hannibal.prototype.addValidators = function addValidators (validators) {
  var self = this;
  Object.keys(validators).forEach(function (type) {
    if (!self.validators[type]) {
      self.validators[type] = {};
    }
    self.validators[type] = Object.assign({}, self.validators[type], validators[type]);
  });
};
...
Hannibal.prototype.create = function buildValidator (schema) {
  ...
  return function validator (input, opts) {
    var validatorObj = {
      ...
      opts: opts || {},
      originalData: Object.assign({}, input)
    };
    ...
    if (typeof (schema) === "boolean") {
      return {
        ...
        data: validatorObj.originalData,
        error: null,
      }
    }

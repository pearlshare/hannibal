...
module.exports = function validate (testSchema, origValue, output, error, validatorObj) {
  ...
  /*
    Step 3: Perform any transforms before validation

    A second set of transforms is run. This is so that any objects
    which contain only invalid attributes can be collapsed. For example
    an object which has no valid values should collapse into an empty array
   */
